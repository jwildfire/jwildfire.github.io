...
The obvious question after a weekend like that is *how*[^how]? The next post describes how I moved from the OpenClaw Obot experiment of [diary #2]({% post_url 2026-06-12-setting-up-obot-openclaw %}) to Obot v3 — a Claude Code scaffold built around a public roadmap and an agent playbook.
...
[^how]: I promise the answer isn't "work all weekend". I watched 2 World Cup games and played with the kids, too!
